package com.tweetapp.tweets.constants;

public final class MessageConstants {
	public static final int USER_ID_COUNT_VALUE = 1;
	public static final String USER_REGISTRATION_MESSAGE = "User Registration SuccessFully";
	public static final String USER_UNREGISTRATION_MESSAGE = "User Registration UnSuccessFully";
	public static final String LOGIN_SUCCESSFULLY_MESSAGE = "Login SuccessFully";
	public static final String LOGIN_UNSUCCESSFULLY_MESSAGE = " Login UnSuccessFully Please Try With Registered UserName";
	public static final String PASSWORD_RESET_SUCCESSFULLY = "Password Reset SuccessFully";
	public static final String PASSWORD_RESET_UNSUCCESSFULLY = "Password Reset UnSuccessFully";
	...
	public static final String USER_RESET_PASSWORD_SERVICE_METHOD_NAME = "resetPasswordService";
	public static final String GET_ALL_REGISTARTION_USER_METHOD_NAME = "getAllRegistartionUser";
	public static final String GET_USER_BY_USERNAME_METHOD_NAME = "getUserByUserName";

	public static final String SAVE_USER_REGISTER_DETAILS_METHOD_NAME = "saveUserRegisterDetails";
	public static final String SAVE_USER_RESET_PASSWORD_DETAILS_METHOD_NAME = "saveUserResetPassworDetails";
